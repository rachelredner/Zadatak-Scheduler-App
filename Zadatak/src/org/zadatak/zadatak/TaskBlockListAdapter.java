...
\******************************************************************************/
public class TaskBlockListAdapter extends ArrayAdapter<TaskBlock> {
	
	private List<TaskBlock> tasks;
	...
	| view                                                                         |
	\******************************************************************************/
	public TaskBlockListAdapter(Context context, int resource, List<TaskBlock> tasks2) {
		super(context, resource, tasks2);
		this.tasks = tasks2;
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		TaskBlock task = tasks.get(position);
		if (task != null) {
			...
			if (nameBox != null) {
				String taskName = task.task.get(Task.Attributes.Name);
